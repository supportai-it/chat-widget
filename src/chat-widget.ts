class ChatWidget extends HTMLElement {
  ...
  static get observedAttributes() {
    return ["chat-id", "button-color", "button-hover-color", "button-size"];
  }
